...
<meta content="/vR/fgQnpdLyhTrc3hNXgBxhJNLZwvXNne9TA9utlx8=" name="csrf-token" />
    ...
    <ul class="top-nav logged_out">
      ...
      <div class="hentry">
        ...
        <div class="pagehead repohead instapaper_ignore readability-menu">
          ...
          <li>
            <span class="star-button"><a href="/login?return_to=%2Fdouglascrockford%2FJSON-js" class="minibutton js-toggler-target entice tooltipped leftwards" title="You must be signed in to use this feature" rel="nofollow"><span class="mini-icon mini-icon-star"></span>Star</a><a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers">2,571</a></span>
          </li>
          <li>
            <a href="/login?return_to=%2Fdouglascrockford%2FJSON-js" class="minibutton js-toggler-target fork-button entice tooltipped leftwards"  title="You must be signed in to fork a repository" rel="nofollow"><span class="mini-icon mini-icon-fork"></span>Fork</a><a href="/douglascrockford/JSON-js/network" class="social-count">665</a>
          </li>
    </ul>
  ...
  <div class="frame frame-center tree-finder" style="display:none"
      ...
      data-blob-url-prefix="/douglascrockford/JSON-js/blob/master">
...
<div id="slider">
    ...
    <div class="breadcrumb" data-path="json2.js/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/douglascrockford/JSON-js" itemscope="url"><span itemprop="title">JSON-js</span></a></b> / <strong class="final-path">json2.js</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text="json2.js" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter" href="/douglascrockford/JSON-js/edit/master/json2.js" data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
                  </li>
                <li>
...
<div class="frame frame-loading large-loading-area" style="display:none;" data-tree-list-url="/douglascrockford/JSON-js/tree-list/43d7836c8ec9b31a02a31ae0c400bdae04d3650d">
...
<div class="lower_footer">
  <div class="container clearfix">
    <div id="legal">
      ...
      <p>&copy; 2012 <span title="0.05584s from fe17.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.05736' data-host='fe17'></span>
